...
<head>
    ...
    <title>Thông báo đặt hàng thành công | Shop GPM </title>
</head>
            ...
            <div class="row" style="background-color: #00509d; height: 200px; padding: 35px; color: white;">
                <div class="container-fluid">
                    <h3 class="m-0 p-0 mt-4" style="margin-top: 0; font-size: 28px; font-weight: 500;">
                        ...
                        <br>
                        Cám ơn quý khách rất nhiều vì đã ủng hộ Shop chúng tôi
                    </h3>
                    <div class="row mt-5" style="margin-top: 35px; display: flex;">
                        <div class="col-6"
                             style="margin-bottom: 25px; flex: 0 0 50%; width: 50%; box-sizing: border-box;">
                            <b>Họ và tên :</b> {{ $kh->hovaten }}
                            <br>
                            <span>
                                <b>Email :</b> <a style="color: white !important;" href="mailto:{{ $kh->email }}" target="_blank">{{ $kh->email }}</a>
                            </span>
                            <br>
                            <span>Số điện thoại : {{ $kh->dienthoai }} </span>
                        </div>
                            ...
                            <table class="mt-2 w-100"
                                ...
                                <tr style="font-size: 18px;">
                                    ...
                                    <td class="pr-3 text-right" style="text-align: right; padding-right: 20px;">
                                        <b>{{ number_format($giohang->gia + Session::get('phi')) }} ₫</b>
                                    </td>
                                </tr>
                            </table>
                        </div>
